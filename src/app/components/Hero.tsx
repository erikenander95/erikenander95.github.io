  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-4 py-20 relative">
      <div className="max-w-4xl w-full text-center">
        {/* Accent line */}
        <div className="h-1 w-20 mx-auto mb-8" style={{ backgroundColor: '#8B6DDE' }} />
        
        <h1 className="mb-4" style={{ color: '#FFFFFF', fontSize: '3.5rem', fontWeight: '700', lineHeight: '1.2' }}>
          Erik Enander
        </h1>
        ...
        <p className="mb-8 max-w-2xl mx-auto" style={{ color: '#B8B8C0', fontSize: '1.25rem', lineHeight: '1.8' }}>
          Full-stack developer passionate about crafting elegant solutions to complex problems. 
          I build modern web applications with a focus on clean code, user experience, and scalability.
        </p>
        ...
        <div className="flex justify-center gap-4 mb-12">
          <a 
            ...
            style={{ backgroundColor: '#141417', border: '1px solid #2A2A30', boxShadow: '0 0 0 rgba(111, 85, 201, 0)' }}
            onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 20px rgba(111, 85, 201, 0.5)'}
